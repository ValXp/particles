	...
	public class GlEngine extends Engine {
		...
		private class WallpaperGlSurfaceView extends GLSurfaceView {
			...
			private void init(boolean translucent, int depth, int stencil) {
				 ...
				 * format here, using PixelFormat.TRANSLUCENT for GL Surfaces is
				 * interpreted as any 32-bit surface with alpha by
				 * SurfaceFlinger.
				 */
				if (translucent) {
			...
			private class ScaleListener extends
				...
				public boolean onScale(ScaleGestureDetector detector) {
					...
					mScaleFactor = Math
							.max(0.05f, Math.min(mScaleFactor, 1.5f));

					ParticlesCPP.setZoom((10 * mScaleFactor) - 10);
					//((ParticlesActivity) GlWallpaperService).onZoomUpdate(mScaleFactor);
			...
			private static class ConfigChooser implements
				...
				private static int[] s_configAttribs2 = { EGL10.EGL_RED_SIZE,
						4, EGL10.EGL_GREEN_SIZE, 4, EGL10.EGL_BLUE_SIZE, 4,
