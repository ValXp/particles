...
extern "C" {
	JNIEXPORT void JNICALL Java_com_valxp_particles_ParticlesCPP_init(JNIEnv * env, jobject obj,  jint width, jint height, jint pnumber, jfloat ptSize, jboolean motionBlur, jboolean autoCount);
...
JNIEXPORT void JNICALL Java_com_valxp_particles_ParticlesCPP_init(JNIEnv * env, jobject obj,  jint width, jint height, jint pnumber, jfloat ptSize, jboolean motionBlur, jboolean autoCount)
{
	...
	Utils::printABI();
	if (!engine)
		engine = new ParticleEngine(pnumber, autoCount);
